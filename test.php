		...
		<section id="main" role="main">
			...
			<header id="masthead-header">
				...
				<div id="home-header-text">
					<p>
						<span class="block">At Eden, our mission is simple:</span>
						To bring you the freshest food possible.
					</p>
				</div>
			</header>
			
			<section id="masthead">
				<div><img src="img/home-masthead-1.jpg" alt="mac and cheese with bacon" title="mac and cheese with bacon" /></div>
				<div><img src="img/home-masthead-2.jpg" alt="chocolate cake" title="chocolate cake" /></div>
				<div><img src="img/home-masthead-3.jpg" alt="bruschetta" title="bruschetta"  /></div>
				<div><img src="img/home-masthead-4.jpg" alt="manicotti" title="manicotti"  /></div>
				<div><img src="img/home-masthead-5.jpg" alt="ruby vegetable cakes" title="ruby vegetable cakes"  /></div>
				<div><img src="img/home-masthead-6.jpg" alt="chickpea and coconut burger" title="chickpea and coconut burger"  /></div>
				<div><img src="img/home-masthead-7.jpg" alt="peanut tempeh and kale" title="" /></div>
				<div><img src="img/home-masthead-8.jpg" alt="general tso's chicken" title="general tso's chicken"   /></div>
			</section>	
			...
			<section class="margin-bottom-25 easy-clearing">
				...
				<div id="hp-hours-text">
					<ul>
						<li>
							<div id="hp-date-define" class="float-left">Lunch</div> 
							<div id="hp-date-list">
								<p>Monday, Wednesday, Thursday <span class="footer-mark">5PM - 10PM</span></p>
								<p>Friday, Saturday <span class="footer-mark">5PM - 11PM</span></p>
						...
						<li class="last easy-clearing">
							...
							<div id="hp-date-list">
								...
								<p>Sunday<span class="footer-mark">10AM - 4PM</span></p>
							</div>
						</li>
					</ul>
				</div>
